  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
      <div className="text-center">
        ...
        <Link href="/" className="inline-flex items-center px-4 py-2 mt-8 font-semibold text-purple-600 bg-white rounded-lg shadow-md hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200 transition-colors duration-200">
